...
export default function Harga() {
    return (
        <>
            <h2 className='font-bold text-3xl text-center'>Harga & Layanan</h2>
            <div className='flex justify-center'>
                <div className='border border-slate-100 rounded-3xl shadow-lg bg-violet-50 mt-16 py-10 h-fit w-72 text-center space-y-6 '>
                ...
                <div className='border border-slate-100 rounded-3xl shadow-lg bg-indigo-900 mt-16 py-10 h-fit w-72 text-center space-y-6 mx-6'>

            ...
            <nav>
                <div className={`${show ? '' : 'transform translate-y-14'} block left-2/4 -translate-x-2/4 fixed bottom-4 transition-transform duration-1000`}>
                    <div className='flex justify-center' onClick={() => setShow(!show)}>
                        <div className={`${show ? 'tranform translate-y-12 ' : 'rotate-180 '} flex justify-center transition duration-1000 cursor-pointer`}>
                            <div className='h-1 w-4 rounded-md bg-slate-600 rotate-45'></div>
                            <div className='h-1 w-4 rounded-md bg-slate-600 -rotate-45 -ml-2'></div>
                        </div>
                    </div>
